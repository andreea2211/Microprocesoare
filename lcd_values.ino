...
{
  //analogRead citeste tensiunea la A0(tensiunea la ierire a amplificatorului) si A1(tensiunea intre rezistena si dioda)
  int measureA0 = analogRead(A0);
  int measureA1 = analogRead(A1);
  volts = measureA0 * 5.0 / 1024.0;
  amps = (measureA0 - measureA1) * 5.0 * 1000.0 / (1024.0 * 270.0);
}
...
{
  // refresh display interval check
